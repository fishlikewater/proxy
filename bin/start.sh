...
if [ -n "$BITS" ]; then
  JAVA_MEM_OPTS=" -server -Xms256m -Xmx256m -Xmn120m -Xss256k -XX:MetaspaceSize=128M -XX:CompressedClassSpaceSize=128m -XX:SurvivorRatio=3 -XX:+UseG1GC -Xloggc:gc.log -XX:+UseGCLogFileRotation -XX:NumberOfGCLogFiles=10 -XX:GCLogFileSize=100M -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintGCTimeStamps"
else
  JAVA_MEM_OPTS=" -server -Xms256m -Xmx256m -XX:SurvivorRatio=2 -XX:+UseParallelGC -XX:MetaspaceSize=128M -XX:CompressedClassSpaceSize=128m "
fi
